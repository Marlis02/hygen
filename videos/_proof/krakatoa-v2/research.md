...
Proof-ролик сессии D4: три бита Krakatoa на языке stage + devices. Пересказывает `videos/krakatoa-en` в том же мире (look storm), полный пересказ — D6.
...
Расстояние на карте: Krakatoa 6.102 S 105.423 E → x 590, y 628 px; 4 800 км ≈ 405 px (engine/assets/maps/indian-ocean.license.json).
