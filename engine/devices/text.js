/* hygen text — engine/devices/text.js: the shared text schema (engine/devices/text.schema.json) of every text on screen —
   text.title, text.quote, annotate.label, text.caption, text.kinetic: type (one of the eight entrances of
   engine/motion/type.json), font, size, case, color, background, position. Bundled first into assets/hygen/devices.js
