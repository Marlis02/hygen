...
HygenDevices.define("text.title", function (api, dev) {
  ...
  var kicker = P.kicker || "";
  var size = api.sizes[P.size] || api.sizes.headline;
  ...
  else { boxW = 900; cx = 540; cy = 380; lx = 90; }
  ...
  var top = Math.max(140, Math.min(1420 - blockH, cy - blockH / 2));
  ...
  var tEl = api.el("div", { style: { fontFamily: api.F.display, fontWeight: "600", fontSize: size + "px", lineHeight: "1.02", letterSpacing: "-0.01em", color: col, textWrap: "balance", textShadow: shadow } }, wrap);
