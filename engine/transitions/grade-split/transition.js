/* transition grade-split — engine/transitions/grade-split (after registry grade-split-reveal,
   engine/transitions/vendor/grade-split-reveal): the component grades one layer and reveals the other along a split;
