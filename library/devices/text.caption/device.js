/* text.caption — library/devices/text.caption/device.js: the captions of a video as a device (library/scenes/CONTRACT.md,
   ...
   (library/captions/presets/<name>.js) builds its words in the box:
...
(function () {
  ...
  function mountGroup(tl, CFG, stage, g, shared) {
    ...
    if (!def) throw new Error("hygen: пресет субтитров «" + g.style.preset + "» не загружен (library/captions/presets/" + g.style.preset + ".js)");
