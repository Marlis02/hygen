/* text.title — calm is a port of registry titlecard-calm (library/devices/vendor/titlecard-calm): kicker fades and
...
HygenDevices.define("text.title", function (api, dev) {
  ...
  // shared text schema (library/devices/text.schema.json): font, size, case, color, background, position, type
