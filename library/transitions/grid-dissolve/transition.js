/* transition grid-dissolve — library/transitions/grid-dissolve (after registry grid-pixelate-wipe,
   library/transitions/vendor/grid-pixelate-wipe): 9 × 16 cells of ink; each cell has its own seeded moment — it lands
