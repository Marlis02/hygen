---
version: alpha
name: Pompeii Ash — Frame (video / frame layer)
description: >
  Frame-scale design system for the vertical faceless explainer "Гибель Помпей". Derived from the
  ...
  All on-screen copy is Cyrillic — both families ship Cyrillic glyphs as local files.
...
# Pompeii Ash — Frame (video / frame layer)
