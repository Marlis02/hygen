...
Пересказ по раскадровке-доказательству `projects/titanic-v2` на движке v2: история корабля, в который трудно не поверить. Старая версия (сцены D2: счётчик 2:40 → карта → глубина → 1985 → фото → дробь 1/3) — `history/2026-09-14/`.
